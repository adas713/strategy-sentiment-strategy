...
[![GitHub Stars](https://img.shields.io/github/stars/adas713/strategy-sentiment-strategy?style=for-the-badge&logo=github)](https://github.com/adas713/strategy-sentiment-strategy)
...
```bash
# Clone repository
git clone https://github.com/adas713/strategy-sentiment-strategy.git
cd strategy-sentiment-strategy
...
```python
from strategy import SentimentStrategyStrategy

# Initialize strategy
strategy = SentimentStrategyStrategy()
...
- **Documentation**: [Wiki](https://github.com/adas713/strategy-sentiment-strategy/wiki)
- **Issues**: [GitHub Issues](https://github.com/adas713/strategy-sentiment-strategy/issues)
- **Discussions**: [GitHub Discussions](https://github.com/adas713/strategy-sentiment-strategy/discussions)
